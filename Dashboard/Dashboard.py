...
dataset_bike = pd.read_csv("https://raw.githubusercontent.com/jesikasinulingga/Submission-Proyek-Analisis-Data-dengan-Python-Dicoding/main/Dashboard/dataset_bike.csv")
...
st.subheader('NAMA: JESICA EMARAPENTA')
...
colors = ['#00FF00', '#C0C0C0', '#F6F193', '#F2C18D']
...
colors = ['#00FF00', '#FEECE2', '#C0C0C0', '#E2BFB3']
plt.figure(figsize=(10, 5))
...
df_rent_by_weather
colors = ['#00FF00', '#FEECE2', '#F7DED0', '#C0C0C0']
plt.figure(figsize=(10, 5))
sns.barplot(
    y="total_count", 
    x="weather",
